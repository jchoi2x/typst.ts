...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_297: (a: number, b: number, c: number) => number;
  readonly __wasm_bindgen_func_elem_76: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_295: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_296: (a: number, b: number) => number;
  readonly __wasm_bindgen_func_elem_1211: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_1205: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_294: (a: number, b: number) => number;
  readonly __wasm_bindgen_func_elem_69823: (a: number, b: number, c: number, d: number) => void;
