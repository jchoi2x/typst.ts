...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_706: (a: number, b: number) => number;
  readonly __wasm_bindgen_func_elem_240: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_965: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_978: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_704: (a: number, b: number, c: number) => number;
  readonly __wasm_bindgen_func_elem_707: (a: number, b: number) => number;
  readonly __wasm_bindgen_func_elem_705: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_37384: (a: number, b: number, c: number, d: number) => void;
